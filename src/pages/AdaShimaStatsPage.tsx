...
const AdaShimaStatsPage: React.FC = () => {
  ...
  const [filterType, setFilterType] = useState<'all' | 'main' | 'short' | 'special' | 'upcoming'>(
    'all',
  );
  ...
  const [publicationGaps, setPublicationGaps] = useState<
  ...
  const filteredVolumes = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      filtered = filtered.filter(
        (v) =>
          v.title.toLowerCase().includes(query) || v.volume_number.toLowerCase().includes(query),
      );
    }
  ...
  const calculateStats = useCallback((data: VolumeData[]) => {
    ...
    let mostPages = activeVolumes.reduce(
      ...
      activeVolumes[0] || ({ page_count: 0, title: '' } as VolumeData),
    );
    let leastPages = activeVolumes.reduce(
      (min, v) => (v.page_count < min.page_count ? v : min),
      activeVolumes[0] || ({ page_count: Infinity, title: '' } as VolumeData),
    );
    ...
    let fastest = translated.reduce(
      ...
      translated[0] || ({ jp_en_gap_days: Infinity, title: '' } as VolumeData),
    );
    let slowest = translated.reduce(
      (max, v) => (v.jp_en_gap_days > max.jp_en_gap_days ? v : max),
      translated[0] || ({ jp_en_gap_days: 0, title: '' } as VolumeData),
    );
  ...
  const maxPagesValue = Math.max(
    ...volumes.filter((v) => v.page_count > 0).map((v) => v.page_count),
  );
  const maxDelayValue = Math.max(
    ...volumes.filter((v) => v.jp_en_gap_days > 0).map((v) => v.jp_en_gap_days),
  );
  const maxChaptersValue = Math.max(
    ...volumes.filter((v) => v.chapters > 0).map((v) => v.chapters),
  );
  ...
  return (
    <div className={`adashima-stats-page ${isLoaded ? 'loaded' : ''}`}>
      ...
      <div className="stats-content">
          ...
          <section className="hero-section section-reveal" onClick={handleEasterEggClick}>
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                An interactive statistics archive exploring the publication history, translation
                timeline, and structure of the entire series.
              </p>
              ...
              <div className="hero-stats-grid">
                ...
                <AnimatedCounter
                  target={
                    parseInt(statsSummary.publicationEnd) -
                    parseInt(statsSummary.publicationStart) +
                    1
                  }
                  label="Years Active"
                />
                    ...
                    <div key={volume.id} className="timeline-item stagger-card">
                      <div className="timeline-item-connector">
                        <div
                          ...
                          style={{
                            backgroundColor: volume.is_short_story
                              ? '#8b5cf6'
                              : volume.is_special
                                ? '#f9b55d'
                                : '#6366f1',
                        ...
                        />
                        {index < arr.length - 1 && <div className="timeline-item-line" />}
                      </div>
                      ...
                      <div className="timeline-item-content">
                        <div className="timeline-item-header">
                          ...
                          <span className="timeline-item-number">#{volume.volume_number}</span>
                        </div>
        ...
        <div
          ref={(el) => {
            sectionRefs.current.translation = el;
          }}
                ...
                return (
                  <div key={volume.id} className="translation-item stagger-card">
                    ...
                    <div className="translation-item-dates">
                      <span>JP: {formatDate(volume.jp_release)}</span>
                      <span>
                        → {volume.en_completion ? formatDate(volume.en_completion) : 'Pending'}
                      </span>
                    </div>
                  </div>
                );
                    ...
                    .map((volume) => {
                      ...
                      return (
                        <div
                          ...
                          title={`${volume.title}: ${volume.page_count} pages`}
                        >
                          ...
                          <span className="chart-bar-label">{volume.volume_number}</span>
                    ...
                    .map((volume) => {
                      ...
                      return (
                        <div
                          key={volume.id}
                          className="chart-bar-group"
                          title={`${volume.title}: ${volume.chapters} chapters`}
                        >
                          <div className="chart-bar-wrapper">
                            <div
                              className="chart-bar"
                  ...
                  {cumulativePages.map((item, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="chart-bar-group"
                        title={`Volume ${item.volume}: ${item.pages} total pages`}
                      >
                        <div className="chart-bar-wrapper">
                          <div
                        ...
                        <span className="chart-bar-label">{item.volume}</span>
                      </div>
                    );
                  })}
                </div>
                ...
                <div className="chart-bars chart-bars-horizontal">
                  {delayTrendData.map((item, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="chart-bar-group chart-bar-group-horizontal"
                        title={`${item.title}: ${item.delay} days`}
                      >
                  ...
                  {publicationGaps.map((gap, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="gap-item"
                        title={`${gap.from} → ${gap.to}: ${gap.days} days`}
                      >
            ...
            <div className="compare-controls">
              <div className="compare-select">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setCompareVolume1(e.target.value ? Number(e.target.value) : null)
                  }
                >
              ...
              <div className="compare-select">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setCompareVolume2(e.target.value ? Number(e.target.value) : null)
                  }
                >
                  <option value="">Select Volume</option>
                  {volumes
                ...
                <div className="compare-card">
                  ...
                  <div className="compare-stats">
                    <div className="compare-stat">
                      ...
                      <span
                        className={`compare-stat-value ${compareVol1.page_count > compareVol2.page_count ? 'winner' : compareVol1.page_count < compareVol2.page_count ? 'loser' : ''}`}
                      >
                    ...
                    <div className="compare-stat">
                      ...
                      <span
                        className={`compare-stat-value ${compareVol1.chapters > compareVol2.chapters ? 'winner' : compareVol1.chapters < compareVol2.chapters ? 'loser' : ''}`}
                      >
                    ...
                    <div className="compare-stat">
                      ...
                      <span className="compare-stat-value">
                        {formatDate(compareVol1.jp_release)}
                      </span>
                    </div>
                    <div className="compare-stat">
                      <span className="compare-stat-label">EN Completion</span>
                      <span className="compare-stat-value">
                        {compareVol1.en_completion ? formatDate(compareVol1.en_completion) : '—'}
                      </span>
                    </div>
                    <div className="compare-stat">
                      <span className="compare-stat-label">Translation Delay</span>
                      <span
                        className={`compare-stat-value ${compareVol1.jp_en_gap_days < compareVol2.jp_en_gap_days ? 'winner' : compareVol1.jp_en_gap_days > compareVol2.jp_en_gap_days ? 'loser' : ''}`}
                      >
                ...
                <div className="compare-card">
                  ...
                  <div className="compare-stats">
                    <div className="compare-stat">
                      <span className="compare-stat-label">Pages</span>
                      <span
                        className={`compare-stat-value ${compareVol2.page_count > compareVol1.page_count ? 'winner' : compareVol2.page_count < compareVol1.page_count ? 'loser' : ''}`}
                      >
                    ...
                    <div className="compare-stat">
                      <span className="compare-stat-label">Chapters</span>
                      <span
                        className={`compare-stat-value ${compareVol2.chapters > compareVol1.chapters ? 'winner' : compareVol2.chapters < compareVol1.chapters ? 'loser' : ''}`}
                      >
                    ...
                    <div className="compare-stat">
                      <span className="compare-stat-label">JP Release</span>
                      <span className="compare-stat-value">
                        {formatDate(compareVol2.jp_release)}
                      </span>
                    </div>
                    <div className="compare-stat">
                      <span className="compare-stat-label">EN Completion</span>
                      <span className="compare-stat-value">
                        {compareVol2.en_completion ? formatDate(compareVol2.en_completion) : '—'}
                      </span>
                    </div>
                    <div className="compare-stat">
                      <span className="compare-stat-label">Translation Delay</span>
                      <span
                        className={`compare-stat-value ${compareVol2.jp_en_gap_days < compareVol1.jp_en_gap_days ? 'winner' : compareVol2.jp_en_gap_days > compareVol1.jp_en_gap_days ? 'loser' : ''}`}
                      >
          ...
          <section className="volumes-section section-reveal">
            ...
            <div className="volumes-grid">
              {filteredVolumes.map((volume) => {
                ...
                const elementColor = volume.is_short_story
                  ? '#8b5cf6'
                  : volume.is_special
                    ? '#f9b55d'
                    : '#6366f1';
                  ...
                  >
                    ...
                    >
                      <div className="volume-card-title">
                        <span className="volume-card-number">#{volume.volume_number}</span>
                        <h3>{volume.title}</h3>
                      </div>
                      <div className="volume-card-meta">
                        {volume.is_special && <span className="volume-badge special">Special</span>}
                        {volume.is_short_story && (
                          <span className="volume-badge short">Short Story</span>
                        )}
                        {volume.is_upcoming && (
                          <span className="volume-badge upcoming">Upcoming</span>
                        )}
                        {pageRank &&
                          (pageRank === '#1 Longest' ||
                            pageRank === '#2 Longest' ||
                        ...
                        {delayRank === 'Fastest' && (
                          <span className="volume-badge rank">Fastest TL</span>
                        )}
                        {delayRank === 'Slowest' && (
                          <span className="volume-badge rank">Slowest TL</span>
                        )}
                    ...
                    <div className={`volume-card-body ${isExpanded ? 'expanded' : ''}`}>
                      <div className="volume-card-progress">
                        <div className="volume-progress-item">
                          ...
                          <span className="volume-progress-value">
                            {volume.page_count} / {maxPagesValue}
                          </span>
                        </div>
                        {volume.jp_en_gap_days > 0 && (
                          <div className="volume-progress-item">
                            ...
                            <div className="volume-progress-bar">
                              <div
                                ...
                                style={{
                                  ...
                                  backgroundColor:
                                    volume.jp_en_gap_days < 100
                                      ? '#7eb870'
                                      : volume.jp_en_gap_days > 1000
                                        ? '#e06040'
                                        : '#6366f1',
                                }}
                              />
                      ...
                      <div className="volume-card-details">
                        ...
                        {volume.en_completion && (
                          <div className="volume-card-detail">
                            ...
                            <span className="volume-card-detail-value">
                              {formatDate(volume.en_completion)}
                            </span>
                          </div>
                        )}
                        {volume.jp_en_gap_days > 0 && (
                        ...
                        <div className="volume-card-detail">
                          ...
                          <span className="volume-card-detail-value">
                            {statsSummary.totalPages > 0
                              ? ((volume.page_count / statsSummary.totalPages) * 100).toFixed(1)
                              : 0}
                            %
                          </span>
                        </div>
        ...
        <div
          ref={(el) => {
            sectionRefs.current.funfacts = el;
          }}
          data-section="funfacts"
        >
