...
export const projectsData: Project[] = [
  {
    ...
    slug: 'uniquest',
    subtitle:
      'A mobile-first campus companion that transforms everyday student life through productivity, exploration, and gamified progression.',
    role: 'Lead Developer',
    featured: true,
    status: 'Active',
    category: 'Mobile App',
    ...
    highlights: [
      {
        ...
        description:
          'Turns everyday academic responsibilities into rewarding quests through experience points, levels, and achievements.',
      },
      {
        icon: 'mdi:map-marker-radius',
        title: 'Interactive Campus Map',
        description:
          'Helps students explore university landmarks using interactive location pins with photos and contextual information.',
      },
      {
        icon: 'mdi:trophy-variant',
        title: 'Leaderboard & Cosmetic Rewards',
        description:
          'Turns sustained progress into visible status through competitive leaderboards and unlockable cosmetic customization.',
      },
      {
        icon: 'mdi:cog-sync',
        title: 'Automated Release Pipeline',
        description:
          'A GitHub Actions workflow builds, signs, and publishes Android release APKs automatically on every push to main.',
      },
    ],
  },
  {
    ...
    highlights: [
      {
        ...
        description:
          'Automatically selects the appropriate extraction strategy for both static and JavaScript-rendered novel websites.',
      },
      {
        icon: 'mdi:code-braces',
        title: 'Intelligent HTML Cleaning',
        description:
          'Removes advertisements, translator notes, and unnecessary markup while preserving clean, readable chapter content.',
      },
      {
        icon: 'mdi:book-open-page-variant',
        title: 'Offline Ebook Generation',
        description:
          'Compiles extracted chapters into polished EPUB ebooks and high-quality PDF documents ready for offline reading.',
      },
      {
        icon: 'mdi:puzzle',
        title: 'Modular Pipeline',
        description:
          'Independent download, cleaning, and export stages make the toolkit easy to maintain and extend.',
      },
    ],
  },
  {
    ...
    highlights: [
      {
        ...
        description:
          'Explore a fully interactive 2005-inspired operating system where every application, file, and notification contributes to the experience.',
      },
      {
        icon: 'mdi:book-open-page-variant',
        title: 'Psychological Narrative',
        description:
          'A story-driven experience told through branching dialogue, environmental storytelling, and conversations with the enigmatic CRT.',
      },
      {
        icon: 'mdi:controller-classic',
        title: 'Hybrid Gameplay',
        description:
          'Fluidly transitions between desktop interaction, puzzle-solving, visual novel storytelling, and immersive 3D exploration.',
      },
      {
        icon: 'mdi:robot-angry',
        title: 'Dynamic Enemy AI',
        description:
          'Navigation-based enemy behavior creates tense pursuit sequences that reinforce both gameplay and narrative.',
      },
    ],
  },
  {
    ...
    slug: 'wais-wallet',
    subtitle:
      'A mobile-first personal finance application built around intentional, envelope-style budgeting.',
    role: 'Co-Developer',
    featured: false,
    status: 'Archived',
    category: 'Mobile App',
    ...
    highlights: [
      {
        ...
        description:
          'Assign every peso to a dedicated Wais Pocket before spending, encouraging intentional financial planning.',
      },
      {
        icon: 'mdi:chart-pie',
        title: 'Financial Dashboard',
        description:
          'Track Safe-to-Spend balances, budget allocations, and remaining funds through a clean, centralized overview.',
      },
      {
        icon: 'mdi:piggy-bank',
        title: 'Savings Goals',
        description:
          'Create personalized savings targets and monitor progress with simple, visual indicators.',
      },
      {
        icon: 'mdi:cellphone',
        title: 'Mobile-First Design',
        description:
          'Built with React Native to deliver a consistent, responsive experience across modern mobile devices.',
      },
    ],
  },
  {
    ...
    slug: 'ledgerleaf',
    subtitle:
      'A full-stack personal finance platform built around intentional, pocket-based budgeting and meaningful financial insights.',
    role: 'Sole Developer',
    featured: true,
    status: 'Active',
    category: 'Web App',
    ...
    description:
      'A modern full-stack finance management platform that helps users budget proactively through pocket-based fund allocation, expense tracking, and insightful financial reporting.',
    overview:
    ...
    highlights: [
      {
        ...
        description:
          'Assign every peso to dedicated budgeting pockets before spending, encouraging intentional financial planning.',
      },
      {
        icon: 'mdi:chart-areaspline',
        title: 'Financial Analytics',
        description:
          'Interactive dashboards provide clear insights into spending habits, pocket utilization, savings progress, and overall financial health.',
      },
      {
        icon: 'mdi:piggy-bank',
        title: 'Savings Management',
        description:
          'Create savings goals, monitor progress, and manage deposits while maintaining accurate available balances.',
      },
      {
        icon: 'mdi:file-document-multiple',
        title: 'Comprehensive Reporting',
        description:
          'Generate PDF and Excel reports alongside detailed transaction histories for deeper financial analysis and record keeping.',
      },
    ],
  },
  {
    ...
    highlights: [
      {
        ...
        description:
          'Brings novels, manga, gallery art, music, and translated extras together into one structured, browsable archive.',
      },
      {
        icon: 'mdi:translate',
        title: 'Bilingual by Design',
        description:
          'Serves English and Spanish content from shared data conventions, keeping both locales consistent as the catalogue grows.',
      },
      {
        icon: 'mdi:speedometer',
        title: 'Static-First Performance',
        description:
          'A framework-free, JSON-driven architecture keeps pages lightweight, fast, and simple to deploy on Cloudflare Pages.',
      },
      {
        icon: 'mdi:test-tube',
        title: 'Exhaustive Automated QA',
        description:
          'A Python and Playwright test harness validates catalogue data, page interactions, and performance before every release.',
      },
    ],
  },
];
