...
export const certificatesData: Certificate[] = [
  {
    ...
    description: "Foundational Python programming covering core concepts, functions, collections, exceptions, and problem-solving.",
    skills: ["Python", "Functions", "Data Structures", "Exception Handling", "Problem Solving"],
    topics: ["Python Programming", "Control Flow", "Functions", "Data Structures", "Programming Fundamentals"],
    featured: true,
  ...
  },
  {
    ...
    description: "Modern cyber threat operations including attack techniques, threat analysis, security operations, and risk management.",
    skills: ["Cybersecurity", "Threat Analysis", "Risk Management", "Network Security", "Incident Response"],
    topics: ["Cyber Threats", "Security Operations", "Risk Assessment", "Threat Intelligence", "Network Defense"],
    featured: true,
  ...
  },
  {
    ...
    description: "Cybersecurity fundamentals including digital privacy, common threats, and protecting systems, networks, and personal information.",
    skills: ["Cybersecurity", "Network Fundamentals", "Digital Privacy", "Security Awareness"],
    topics: ["Cybersecurity Fundamentals", "Digital Privacy", "Cyber Threats", "Security Best Practices"],
    featured: false,
